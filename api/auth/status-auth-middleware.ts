...
export function createStatusAuthenticationMiddleware(mode: 'oidc' | 'anonymous') {
    return function statusAuthenticationMiddleware(req: Request, res: Response, next: NextFunction) {
        if (mode === 'anonymous') {
...
export const statusAuthenticationMiddleware = createStatusAuthenticationMiddleware(authMode);
